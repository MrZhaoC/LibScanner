...
# todo:项目依赖文件
dep_file_path = r"F:\zc-data\RQ\RQ2\filter-all-dependency.txt"
# todo: shrink-dex输出文件夹
shrink_dex_output_path = r"F:\zc-data\RQ\RQ2\shrink-dex-output"
# todo: android config输出文件夹
base_rule_config_path = r"F:\zc-data\RQ\RQ2\r8-config"
